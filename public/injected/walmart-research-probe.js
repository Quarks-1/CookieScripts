(function () {
  var EVENT_NAME = "cookiescripts:walmart-probe";
  var BRIDGE_ID = "cookiescripts-walmart-probe-bridge";
  ...
  if (window.__cookieScriptsWalmartProbeHooks) {
    markReady();
    return;
  }
  ...
  window.__cookieScriptsWalmartProbeHooks = true;
