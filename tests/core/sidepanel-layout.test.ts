...
import { isSectionVisible } from "../../ui/popup/core/sidepanel-layout.ts";
...
function status(overrides: Partial<ExtensionStatus>): ExtensionStatus {
  return {
    ...
    retailer_schedule_stop_on_oos: false,
    retailer_close_tab_on_oos: false,
    retailer_schedule_phase: "off",
    ...
    walmart_schedule_enabled: false,
    walmart_schedule_start_time: null,
    walmart_schedule_end_time: null,
    walmart_schedule_phase: "off",
    ...
    samsclub_schedule_enabled: false,
    samsclub_schedule_start_time: null,
    samsclub_schedule_end_time: null,
    samsclub_schedule_stop_on_oos: false,
    samsclub_schedule_phase: "off",
