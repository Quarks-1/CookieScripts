...
import type { BackgroundResponse, ExtensionStatus } from "@ext/types/index.ts";
import { isEffectiveUseMax, isQuantityInvalid } from "@ext/lib/retailer/quantity-limit.ts";
