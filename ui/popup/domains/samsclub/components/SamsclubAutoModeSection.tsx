...
interface SamsclubAutoModeSectionProps {
...
export function SamsclubAutoModeSection({
  openTabs,
  showControls,
  refreshIntervalSec,
  manualStatus,
  ...
  return (
    <section aria-labelledby="samsclub-auto-heading">
      <h2 id="samsclub-auto-heading" className="text-sm font-medium text-zinc-400">
        Sam&apos;s Club Auto Mode
      </h2>
      <SamsclubTabPills openTabs={openTabs} />

      <CompactNumberField
        className="mt-3"
        id="popup-samsclub-refresh-interval"
