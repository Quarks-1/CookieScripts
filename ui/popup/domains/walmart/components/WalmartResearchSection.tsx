...
import type { MarkerLabel, WalmartLastExport, WalmartOpenTabSummary } from "@ext/core/types/index.ts";

import { WalmartTabPills } from "./WalmartTabPills.tsx";
...
interface WalmartResearchSectionProps {
  ...
  lastExport: WalmartLastExport | null;
...
export function WalmartResearchSection({
  openTabs,
  recordingActive,
  recordingTabCount,
  eventCount,
  ...
  return (
    <section aria-labelledby="walmart-research-heading">
      <h2 id="walmart-research-heading" className="text-sm font-medium text-zinc-400">
        Walmart Research
      </h2>
      ...
      {!disclaimerAccepted && (
        <div className="mt-3 rounded border border-amber-700/50 bg-amber-950/30 p-3 text-xs text-amber-100">
          <p>Exports may contain account-related data from your Walmart session. Store ZIPs securely.</p>
          <button
            type="button"
