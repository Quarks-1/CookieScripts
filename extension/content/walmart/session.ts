...
import { startWalmartRecorder } from "@ext/content/walmart/recorder/index.ts";
import { WALMART_SESSION_STORAGE_KEY } from "@ext/lib/walmart/constants.ts";
import {
...
import type { MarkerLabel } from "@ext/types/walmart.ts";

let recorder: Awaited<ReturnType<typeof startWalmartRecorder>> | null = null;
let batcher = new RecordingBatcher();
