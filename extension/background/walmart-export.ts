import { buildExportZip } from "@ext/lib/walmart/export-bundle.ts";
import { revokeDownloadUrl, zipBytesToDownloadUrl } from "@ext/lib/walmart/download-url.ts";
import type { WalmartLastExport } from "@ext/types/walmart.ts";

export async function downloadSessionZip(sessionId: string): Promise<WalmartLastExport> {
