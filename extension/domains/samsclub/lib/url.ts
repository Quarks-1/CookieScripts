import { redactBodySnippet } from "@ext/domains/samsclub/lib/network-redact.ts";
...
export function resolveAbsoluteUrl(url: string, base = SAMSCLUB_ORIGIN): string {
  try {
...
export function parseGraphqlOperation(url: string, base = SAMSCLUB_ORIGIN): string | undefined {
  try {
...
export function redactUrl(url: string, base = SAMSCLUB_ORIGIN): string {
  try {
