...
export function patchSamsclubOpenTabActive<T extends { tabId: number; isActive: boolean }>(
  openTabs: readonly T[],
...
export function isSamsclubOpenTabActive(
  tabId: number,
...
export function applySamsclubOpenTabHighlights<T extends { tabId: number; isActive: boolean }>(
  openTabs: readonly T[],
  focusedActiveTabId?: number,
): T[] {
  ...
  return patchSamsclubOpenTabActive(openTabs, focusedActiveTabId);
}
