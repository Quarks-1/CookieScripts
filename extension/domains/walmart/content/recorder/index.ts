...
import { createSessionLimitState } from "@ext/domains/walmart/lib/recording-limits.ts";
import {
  ensureWalmartResearchProbe,
  listenWalmartProbe,
  removeWalmartResearchProbe,
} from "@ext/domains/walmart/lib/page-probe-bridge.ts";
import { detectAutoMarker } from "@ext/domains/walmart/content/recorder/auto-markers.ts";
import { attachButtonStatePolling } from "@ext/domains/walmart/content/recorder/button-polling.ts";
import { attachClickCapture } from "@ext/domains/walmart/content/recorder/clicks.ts";
import { RecordingBatcher } from "@ext/domains/walmart/content/recorder/batching.ts";
import {
  readStorageKeyNames,
  scanDomSummary,
} from "@ext/domains/walmart/content/recorder/dom-summary.ts";
import { attachFormCapture } from "@ext/domains/walmart/content/recorder/forms.ts";
import {
  attachNavigationCapture,
  navigationEvent,
} from "@ext/domains/walmart/content/recorder/navigation.ts";
import { collectResourceTimingEvents } from "@ext/domains/walmart/content/recorder/perf-backfill.ts";
import { probeDetailToEvent } from "@ext/domains/walmart/content/recorder/probe-listener.ts";
import { capturePageSnapshot } from "@ext/domains/walmart/content/recorder/snapshots.ts";
import { addNetworkBytes, estimateBytes } from "@ext/domains/walmart/lib/recording-limits.ts";
import type { MarkerLabel, WalmartRecordingEvent } from "@ext/domains/walmart/types/walmart.ts";
