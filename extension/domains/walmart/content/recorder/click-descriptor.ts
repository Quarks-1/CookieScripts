...
import { describeClickLabel } from "@ext/domains/walmart/content/recorder/click-label.ts";
import type { ElementDescriptor } from "@ext/domains/walmart/types/walmart.ts";
